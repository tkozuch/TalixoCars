...
class Car(models.Model):
    ...
    category = models.CharField(choices=CarClassChoices.choices, max_length=30,
                                default=CarClassChoices.BUSINESS)
    motor_type = models.CharField(choices=MotorTypeChoices.choices, max_length=40,
                                  default=MotorTypeChoices.HYBRID)
